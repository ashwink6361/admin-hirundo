...
(function () {
    ...
    angular.module('BlurAdmin.pages.rooms').factory('RoomService', RoomService)
        .provider('RoomOrderService', RoomOrderServiceProvider);

    function RoomOrderServiceProvider() {
        var _orderSidebar = false;
        this.$get = function () {
            return new _factory();

            function _factory() {
                this.setOrderSidebar = function (data) {
                    _orderSidebar = data;
                };
                this.getOrderSidebar = function () {
                    return _orderSidebar;
                };
            }
        }
    }
